...
KEYFRAME_SCENE_GENERATION_PROMPT = '''You are a master storyteller and dialogue writer. For each keyframe, you will create two connected scenes that occur in the same setting and timespan:
